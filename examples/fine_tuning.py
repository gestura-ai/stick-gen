...
def fine_tune(model, dataloader, epochs: int, learning_rate: float, device: str = "cpu"):
    """Fine-tune the model."""
...
def main():
    parser = argparse.ArgumentParser(description="Fine-tune pre-trained model on custom data")
    parser.add_argument("--checkpoint", type=str, required=True, help="Path to pre-trained checkpoint")
    parser.add_argument("--config", type=str, required=True, help="Path to configuration file")
    parser.add_argument("--data", type=str, required=True, help="Path to custom dataset (.pt file)")
