...
# ============================================================================
    ...
    def forward(
        ...
        text_features = text_features.unsqueeze(1).expand(-1, seq_len, -1)  # [batch, seq_len, d_model]
        
        # Embed motion sequence
        motion_features = self.motion_embedding(motion_sequence)  # [batch, seq_len, d_model]
        ...
        if action_sequence is not None:
            ...
            action_features = self.action_projection(action_emb)  # [batch, seq_len, d_model]
        ...
        combined_features = combined_features.transpose(0, 1)  # [seq_len, batch, d_model]
        encoded = self.transformer_encoder(combined_features)  # [seq_len, batch, d_model]
