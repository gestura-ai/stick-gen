...
from src.data_gen.convert_amass import infer_action_from_filename, generate_description_from_action, AMASS_ACTION_MAPPING
...
def main():
    ...
    print(f"  Valid: {quality_stats['valid']} ({quality_stats['valid']/quality_stats['total']*100:.1f}%)")
    print(f"  Invalid: {quality_stats['invalid']} ({quality_stats['invalid']/quality_stats['total']*100:.1f}%)")
