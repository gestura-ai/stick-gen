...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='validation_videos', help='Output directory')
    ...
    for i, seq_path in enumerate(sampled_sequences, 1):
        ...
        # Render video
        output_path = output_dir / f"sample_{i:02d}_{metadata['dataset']}_{metadata['action']}.mp4"
        title = f"{metadata['dataset']} - {metadata['action']}\n{metadata['description']}"
